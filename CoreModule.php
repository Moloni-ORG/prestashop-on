...
use MoloniOn\Hooks\AdminOrderButtons;
use MoloniOn\Hooks\OrderStatusUpdate;
use MoloniOn\Hooks\ProductSave;
use MoloniOn\Hooks\ProductStockUpdate;
use MoloniOn\MoloniContext;
use MoloniOn\Tools\SyncLogs;

include_once __DIR__ . '/src/Webservice/WebserviceSpecificManagementMoloniOnResource.php';
...
class CoreModule extends Module
{
    ...
    {
        return $this->get('molonion.context');
    }
