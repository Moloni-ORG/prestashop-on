...
namespace MoloniOn\Services\PrestashopProduct;
...
use MoloniOn\Services\PrestashopProduct\Helpers\Combinations\UpdatePrestaCombinationImage;
...
class ProductCombination implements BuilderInterface
{
     ...
     *
     * @return array|null Stock log entry, or null when nothing to sync
     */
    public function updateStock(): ?array
    {
        ...
        return (new UpdatePrestaProductStock((int) $this->prestashopProduct->id, (int) $this->prestashopCombination->id, $this->reference, $this->stock))->handle();
    }
