...
use MoloniOn\Entity\MoloniOnSyncLogs;
use MoloniOn\Enums\SyncLogsType;
use MoloniOn\MoloniContext;
use MoloniOn\Repository\MoloniOnSyncLogsRepository;
...
class SyncLogs
{
     ...
     *
     * @var MoloniOnSyncLogsRepository
     */
    ...
    public function __construct(EntityManagerInterface $entityManager, MoloniContext $context)
    {
        ...
        self::$syncLogsRepository = $entityManager->getRepository(MoloniOnSyncLogs::class);
