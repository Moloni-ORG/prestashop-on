...
namespace MoloniOn\Controller\Admin\Documents;

use MoloniOn\Actions\Documents\DocumentsDownloadPdf;
...
class Documents extends MoloniController
{
    ...
    public function home(): Response
    {
        ...
        /** @var MoloniOnOrderDocumentsRepository $moloniDocumentRepository */
    ...
    public function view(): RedirectResponse
    {
        ...
        try {
            ...
            $msg = $this->trans($e->getMessage(), 'Modules.Molonion.Errors');
    ...
    public function restore(): RedirectResponse
    {
        ...
        try {
            ...
            $msg = $this->trans('Order restored with success.', 'Modules.Molonion.Common');
