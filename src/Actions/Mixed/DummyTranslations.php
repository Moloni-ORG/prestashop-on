...
class DummyTranslations
{
    ...
    public function errors(): void
    {
        ...
        $this->translator->trans('Error creating {0} hook', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error deleting hooks', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error paginating request', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Code missing', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Request error', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching tokens', [], 'Modules.Molonion.Errors');
        $this->translator->trans('The client credentials are invalid', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating category', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching categories', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating tax: ({0} - {1})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching taxes', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating customer ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error updating customer ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching countries', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching customer next number', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Customer has invalid VAT for Spain.', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching customer by VAT: ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching customer by e-mail: ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating delivery method: ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error getting load country', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error getting delivery country', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching delivery methods', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching payment methods', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating payment method: ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching product by reference: ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating shipping product', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Shipping has no taxes applied. Please add an exemption reason in plugin settings.', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching shipping by reference: ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error creating {0} attribute group', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching property group', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching property groups', [], 'Modules.Molonion.Errors');
        ...
        $this->translator->trans('Error creating stock movement ({0})', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error fetching company data', [], 'Modules.Molonion.Errors');
        ...
        $this->translator->trans('Error fetching document fiscal zone', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Error occurred setting document dates', [], 'Modules.Molonion.Errors');
        $this->translator->trans('Could not find exchange rate: ({0})', [], 'Modules.Molonion.Errors');
    ...
    public function settings(): void
    {
        ...
        $this->translator->trans('Description', [], 'Modules.Molonion.Settings');
        $this->translator->trans('Categories', [], 'Modules.Molonion.Settings');
        $this->translator->trans('Image', [], 'Modules.Molonion.Settings');
        $this->translator->trans('Identifiers', [], 'Modules.Molonion.Settings');
        $this->translator->trans('Visibility', [], 'Modules.Molonion.Settings');
    }
